define([], function () {
	...
	appConfig.skins = [
		{
			name: 'smart-style-0',
			logo: 'apps/demo/_assets/img/logo.png',
		...
		{
			name: 'smart-style-1',
			logo: 'apps/demo/_assets/img/logo-white.png',
		...
		{
			name: 'smart-style-2',
			logo: 'apps/demo/_assets/img/logo-blue.png',
		...
		{
			name: 'smart-style-3',
			logo: 'apps/demo/_assets/img/logo-pale.png',
