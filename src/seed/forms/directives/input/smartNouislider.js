define(['seed/forms/module', 'nouislider'], function (module) {
	'use strict';
	...
	return module.registerDirective('smartNouislider', function ($parse) {
		return {
			...
			compile: function (tElement, tAttributes) {
				...
				if (tAttributes.step) {
					options.step = parseInt(tAttributes.step);
				}

				if (tAttributes.connect) {
					options.connect = tAttributes.connect === 'true' ? true : tAttributes.connect;
				}
