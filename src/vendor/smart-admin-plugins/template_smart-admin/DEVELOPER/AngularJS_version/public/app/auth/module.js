		...
		$stateProvider.state('realLogin', {
			...
			data: {
				...
				.state('login', {
					...
					views: {
						root: {
							templateUrl: 'app-demo/app/auth/views/login.html'
						}
					},
					data: {
						title: 'Login',
				...
				.state('register', {
					...
					views: {
						root: {
							templateUrl: 'app-demo/app/auth/views/register.html'
						}
					},
					data: {
						title: 'Register',
				...
				.state('forgotPassword', {
					...
					views: {
						root: {
							templateUrl: 'app-demo/app/auth/views/forgot-password.html'
						}
					},
					data: {
				...
				.state('lock', {
					...
					views: {
						root: {
							templateUrl: 'app-demo/app/auth/views/lock.html'
						}
					},
					data: {
						title: 'Locked Screen',
