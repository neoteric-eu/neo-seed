...
jvm.$ = jQuery, jvm.AbstractElement = function (e, t) {
	...
	bindContainerTouchEvents: function () {
		var e, t, n = this, r, i, s, o, u, a = function (a) {
			...
			f[0].pageY) / n.scale, n.applyTransform(), n.label.hide(), (h != n.transX || p != n.transY) &&
			...
			(f[1].pageX - f[0].pageX) /
			2, f[0].pageY > f[1].pageY ? o = f[1].pageY + (f[0].pageY - f[1].pageY) / 2 : o = f[0].pageY +
			(f[1].pageY - f[0].pageY) /
			2, s -= l.left, o -= l.top, e = n.scale, t = Math.sqrt(Math.pow(f[0].pageX - f[1].pageX, 2) +
	...
	createMarkers: function (e) {
		...
		for (t in e) {
			i = e[t] instanceof Array ? {latLng: e[t]} : e[t], r = this.getMarkerPosition(i), r !==
			!1 &&
	...
	repositionMarkers: function () {
		...
		for (e in this.markers) {
			t = this.getMarkerPosition(this.markers[e].config), t !==
			!1 &&
