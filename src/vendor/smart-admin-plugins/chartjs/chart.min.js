...
(function () {
	...
	var d = c.helpers = {}, e = d.each = function (a, b, c) {
		...
		for (var k           = Math.abs(i - j), l = u(k), m = Math.ceil(i / (1 * Math.pow(10, l))) *
			...
			n, r               = Math.pow(10, l), s = Math.round(o / r); (s > g || g > 2 * s) &&
		     !h;)if (s > g)r *= 2, s = Math.round(o / r), s % 1 !== 0 && (h = !0); else if (e &&
			l >=
			0) {
			if (r / 2 % 1 !== 0)break;
	...
	c.instances = {}, c.Type = function (a, b, d) {
		...
		"draw": function () {
			...
			switch (a.fillStyle = this.fillColor, this.yAlign) {
				...
				case"below":
					...
					b), a.lineTo(this.x + this.caretHeight, this.y + b + this.caretHeight), a.lineTo(this.x -
		...
		"initialize": function () {
			...
			this.xPadding, this.getLineHeight(0)), a.font = this.font, d.each(this.labels, function (b, c) {
				a.fillStyle = this.textColor, a.fillText(b, this.x +
				this.xPadding +
				this.fontSize +
				3, this.getLineHeight(c + 1)), a.fillStyle = this.legendColorBackground, a.fillRect(this.x +
				this.xPadding, this.getLineHeight(c + 1) -
				this.fontSize /
				2, this.fontSize, this.fontSize), a.fillStyle = this.legendColors[c].fill, a.fillRect(this.x +
				this.xPadding, this.getLineHeight(c + 1) - this.fontSize / 2, this.fontSize, this.fontSize)
			}, this)
		}
