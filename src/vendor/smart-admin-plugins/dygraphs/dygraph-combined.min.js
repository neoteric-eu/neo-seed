...
(Date.prototype.locale = document.getElementsByTagName("html")[0].lang), Date.ext.locales = {}, Date.ext.locales.en = {
	...
	"run": function (a, b) {
		...
		return a.arguments && a.stack ? "chrome" : "string" ==
		typeof a.message &&
		"undefined" !=
		typeof window &&
...
Dygraph.NAME = "Dygraph", Dygraph.VERSION = "1.0.1", Dygraph.__repr__ = function () {
	...
	for (var d = 0; d < this.axes_.length; d++)"undefined" !=
	typeof this.axes_[d].valueWindow &&
	null !==
	...
	if (this.clearSelection(), a) {
		...
		this.doAnimatedZoom(g, h, i, j, function () {
			...
			n.axes_[a].valueWindow &&
			delete n.axes_[a].valueWindow;
	...
	this.attr_("unhighlightCallback")(a), this.attr_("hideOverlayOnMouseOut") &&
	!this.lockedSet_ &&
	this.clearSelection()
	...
	if (void 0 !==
		this.axes_ &&
		this.user_attrs_.hasOwnProperty("valueRange") ===
		!1)for (a = [], c = 0; c < this.axes_.length; c++)a.push(this.axes_[c].valueWindow);
	...
	o &&
	(this.warn("DataTable is out of order; order it correctly to speed loading."), n.sort(function (a, b) {
		return a[0] - b[0]
...
Dygraph.LOG_SCALE = 10, Dygraph.LN_TEN = Math.log(Dygraph.LOG_SCALE), Dygraph.log10 = function (a) {
	...
	function c(a) {
		return "object" == typeof Node ? a instanceof Node : "object" ==
		typeof a &&
		"number" ==
		typeof a.nodeType &&
		"string" ==
	...
	this.container.innerHTML = "", "undefined" !=
	typeof this.date_graph &&
...
(Dygraph.DEFAULT_ATTRS.axes.x.ticker = Dygraph.dateTicker, Dygraph.DEFAULT_ATTRS.axes.y.ticker = Dygraph.numericTicks, Dygraph.DEFAULT_ATTRS.axes.y2.ticker = Dygraph.numericTicks),Dygraph.Plugins = {},Dygraph.Plugins.Annotations = function () {
	...
	return a.prototype.toString = function () {
		...
		if (a.strokeStyle = "black", e.isZoomed) {
			...
			"px", this.iePanOverlay_.style.height = d + "px", this.iePanOverlay_.style.display = "inline")
