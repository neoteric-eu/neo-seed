    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        ...
        $stateProvider
            ...
            .state('app.form.elements', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/form-elements.html'
                    }
                }
            })
            ...
            .state('app.form.layouts', {
                ...
                views: {
                    "content@app": {
                        ...
                        templateUrl: 'app-demo/modules/forms/views/form-layouts.html',
                        resolve: {
            ...
            .state('app.form.validation', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/form-validation.html'
                    }
                }
            })
            ...
            .state('app.form.bootstrapForms', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/bootstrap-forms.html'
                    }
                }
            })
            ...
            .state('app.form.bootstrapValidation', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/bootstrap-validation.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.form.plugins', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/form-plugins.html',
            ...
            .state('app.form.wizards', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/form-wizards.html',
            ...
            .state('app.form.editors', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/form-editors.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.form.dropzone', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/dropzone.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.form.imageEditor', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/forms/views/image-editor.html',
