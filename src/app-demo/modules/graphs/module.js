		...
		$stateProvider
				...
				.state('app.graphs.flot', {
					...
					views: {
						"content@app": {
							controller: 'FlotCtrl',
							templateUrl: "app-demo/modules/graphs/views/flot-charts.html",
							resolve: {
				...
				.state('app.graphs.morris', {
					...
					views: {
						"content@app": {
							templateUrl: "app-demo/modules/graphs/views/morris-charts.html",
							resolve: {
								deps: $couchPotatoProvider.resolveDependencies([
				...
				.state('app.graphs.inline', {
					...
					views: {
						"content@app": {
							templateUrl: "app-demo/modules/graphs/views/inline-charts.html",
							resolve: {
								deps: $couchPotatoProvider.resolveDependencies([
				...
				.state('app.graphs.dygraphs', {
					...
					views: {
						"content@app": {
							templateUrl: "app-demo/modules/graphs/views/dygraphs-charts.html",
							resolve: {
								deps: $couchPotatoProvider.resolveDependencies([
				...
				.state('app.graphs.chartjs', {
					...
					views: {
						"content@app": {
							templateUrl: "app-demo/modules/graphs/views/chartjs-charts.html",
							resolve: {
								deps: $couchPotatoProvider.resolveDependencies([
