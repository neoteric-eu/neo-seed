    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        ...
        $stateProvider
            ...
            .state('app.tables.normal', {
                ...
                views: {
                    "content@app": {
                        templateUrl: "app-demo/modules/tables/views/normal.html"
            ...
            .state('app.tables.datatables', {
                ...
                views: {
                    "content@app": {
                        templateUrl: "app-demo/modules/tables/views/datatables.html",
                        resolve: {
            ...
            .state('app.tables.jqgrid', {
                ...
                views: {
                    "content@app": {
                        ...
                        templateUrl: "app-demo/modules/tables/views/jqgrid.html",
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
