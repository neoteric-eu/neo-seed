define(['apps/demo/modules/forms/module'], function (module) {
	...
	module.registerController('ImageEditorCtrl', function ($scope) {
		...
		$scope.apiDemoImages = [
			{
				name: 'Lego',
				src: 'apps/demo/_assets/img/superbox/superbox-full-24.jpg',
				bgOpacity: .6
			},
			{
				name: 'Breakdance',
				src: 'apps/demo/_assets/img/superbox/superbox-full-7.jpg',
				bgOpacity: .6
			},
			{
				name: 'Dragon Fly',
				src: 'apps/demo/_assets/img/superbox/superbox-full-20.jpg',
				bgOpacity: 1,
				outerImage: 'apps/demo/_assets/img/superbox/superbox-full-20-bw.jpg'
			}
		];
