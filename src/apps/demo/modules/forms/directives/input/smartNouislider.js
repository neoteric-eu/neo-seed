define(['apps/demo/modules/forms/module', 'nouislider'], function (module) {
	...
	return module.registerDirective('smartNouislider', function ($parse) {
		return {
			...
			compile: function (tElement, tAttributes) {
				...
				if (tAttributes.connect) options.connect = tAttributes.connect ==
				'true' ? true : tAttributes.connect;
