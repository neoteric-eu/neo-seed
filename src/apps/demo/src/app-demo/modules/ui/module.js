    ...
    module.config(function($stateProvider, $couchPotatoProvider){
        ...
        $stateProvider
            ...
            .state('app.ui.general', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/general-elements.html',
            ...
            .state('app.ui.buttons', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/buttons.html',
                        controller: 'GeneralElementsCtrl',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/ui/controllers/GeneralElementsCtrl',
            ...
            .state('app.ui.iconsFa', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/icons-fa.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.ui.iconsGlyph', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/icons-glyph.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/ui/directives/smartClassFilter'
                            ])
            ...
            .state('app.ui.iconsFlags', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/icons-flags.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/ui/directives/smartClassFilter'
                            ])
            ...
            .state('app.ui.grid', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/grid.html'
                    }
                }
            })
            .state('app.ui.treeView', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/tree-view.html',
            ...
            .state('app.ui.nestableLists', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/nestable-lists.html',
                        resolve:{
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.ui.jqueryUi', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/jquery-ui.html',
                        controller: 'JquiCtrl',
                        resolve:{
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.ui.typography', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'app-demo/modules/ui/views/typography.html'
                    }
                }
            })
    });
