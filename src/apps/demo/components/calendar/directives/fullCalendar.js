define(['apps/demo/components/calendar/module', 'fullcalendar'], function (module) {
	...
	module.registerDirective('fullCalendar', function (CalendarEvent, $log, $timeout) {
		return {
			restrict: 'E',
			replace: true,
			templateUrl: 'apps/demo/components/calendar/directives/full-calendar.tpl.html',
			scope: {
				events: "=events"
			},
				...
				function initCalendar() {
					...
					calendar = $calendar.fullCalendar({
						...
						drop: function (date, allDay) { // this function is called when something is dropped
							...
							// we need to copy it, so that multiple events don't have a reference to the same
							// object
