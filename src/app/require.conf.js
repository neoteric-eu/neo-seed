...
requirejs.config({
	...
	paths: {
		...
		'angular-restmod': '../vendor/libs-custom/angular-restmod/angular-restmod',
		'angular-restmod-preload': '../vendor/libs-custom/angular-restmod/plugins/preload.min',
		'angular-restmod-find-many': '../vendor/libs-custom/angular-restmod/plugins/find-many.min',
