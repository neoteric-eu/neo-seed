define(['docs/module'], function (module) {
	 ...
	 */
	function NumberFieldProperties($log, fieldsConf, ValidatorAPI, FieldValidatorsEnum) {
	...
	module.factory('NumberFieldProperties', NumberFieldProperties);
});
