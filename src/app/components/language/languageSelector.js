define(['app'], function (module) {
	 ...
	 * @param componentsConf Module configuration object
	 * @return {{restrict: string, templateUrl: string, scope: boolean, controllerAs: string,
	 *   controller: Function}}
	 */
	function languageSelector($log, LanguageAPI, componentsConf) {
		return {
			restrict: 'EA',
			templateUrl: componentsConf.MODULE_PATH + '/language/language-selector.html',
			scope: true,
			controllerAs: 'vm',
			/**
