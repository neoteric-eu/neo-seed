    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        ...
        $stateProvider
            .state('app.inbox', {
                ...
                views: {
                    content: {
                        templateUrl: 'components/inbox/views/inbox-layout.html',
            ...
            .state('app.inbox.folder', {
                ...
                views: {
                    inbox: {
                        templateUrl: 'components/inbox/views/inbox-folder.html',
            ...
            .state('app.inbox.folder.detail', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'components/inbox/views/inbox-detail.html',
            ...
            .state('app.inbox.folder.replay', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'components/inbox/views/inbox-replay.html',
            ...
            .state('app.inbox.folder.compose', {
                ...
                views: {
                    "inbox@app.inbox": {
                        templateUrl: 'components/inbox/views/inbox-compose.html',
