    ...
    module.config(function ($stateProvider, $couchPotatoProvider) {
        ...
        $stateProvider
            ...
            .state('app.appViews.projects', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/project-list.html',
            ...
            .state('app.appViews.blogDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/blog-demo.html'
                    }
                }
            })
            ...
            .state('app.appViews.galleryDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/gallery-demo.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
            ...
            .state('app.appViews.forumDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/forum-demo.html'
                    }
                }
            })
            ...
            .state('app.appViews.forumTopicDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/forum-topic-demo.html'
                    }
                }
            })
            ...
            .state('app.appViews.forumPostDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/forum-post-demo.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/graphs/directives/inline/sparklineContainer',
            ...
            .state('app.appViews.profileDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/profile-demo.html'
                    }
                }
            })
            ...
            .state('app.appViews.timelineDemo', {
                ...
                views: {
                    "content@app": {
                        templateUrl: 'modules/app-views/views/timeline-demo.html',
                        resolve: {
                            deps: $couchPotatoProvider.resolveDependencies([
                                'modules/graphs/directives/inline/sparklineContainer',
                                'modules/graphs/directives/inline/easyPieChartContainer'
